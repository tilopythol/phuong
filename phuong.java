...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Đang kết nối tới websites nè");
        ...
        System.out.println("Setting DDoS By: Nguyen Thanh Phuong");
        ...
        System.out.println("Bắt Đầu Địt Vào Đầu Web");
    ...
    private void checkConnection(String url) throws Exception {
        ...
        if (responseCode == 200) {
            System.out.println("Đã kết nối tới website");
        }
        Dos.url = url;
    }
